...
class Projects extends React.Component{
  ...
  render(){
    ...
    <li > <button onClick={() => this.setContent(3)} className= "waves-effect waves-light btn grey" style = {{width: 200}}>Surveys</button> </li>
    <li> <button onClick={() => this.setContent(4)} className= "waves-effect waves-light btn grey" style = {{width: 200}}>Junior Job Finder</button> </li>
    <li > <button onClick={() => this.setContent(5)} className= "waves-effect waves-light btn grey" style = {{width: 200}}>React Poker Hands</button> </li>
    <li> <button onClick={() => this.setContent(6)} className= "waves-effect waves-light btn grey" style = {{width: 200}}>Codewars </button> </li>
    </ul>
    </div>
...
const Data = [
  ...
  {title: "MineSweeper", imgUrl : "https://s3.amazonaws.com/poly-screenshots.angel.co/enhanced_screenshots/1095884-original.png", content: "MEAN stack web application that allows users to play MineSweeper and stores the top times in a database. I worked as part of a small group in which I created the game logic using angular.", tools: "Angular, NodeJS, MongoDB, Express,  HTML & CSS", linkDescription: "Deployed Application", linkUrl:"https://pumpkin-cupcake-30023.herokuapp.com/#!/game"},
  ...
  {title: "Survey Sender", imgUrl : "http://www.newcastlewest.org/wp-content/uploads/2016/03/survey.jpg", content: "Full-Stack web application that uses Sendgrid to allow users to collect inforation through email surveys.", tools: "React, Node, Express, MongoDB, Sendgrid, Stripe, Google OAuth", linkDescription: "Deployed Application", linkUrl:"https://blooming-coast-83910.herokuapp.com"},
